...
canvas.drawText(message: "subhumans", at: Point(x: 15, y: 330), size: 49, kerning: 0)

// now to add subtext #1
canvas.drawText(message: "friday, april 13 1984", at: Point(x: 15, y: 430), size: 10, kerning: 0)
canvas.drawText(message: "advance $6.50, door $7.50", at: Point(x: 15, y: 415), size: 10, kerning: 0)
canvas.drawText(message: "no age limit", at: Point(x: 15, y: 400), size: 10, kerning: 0)
...
// Subtext #3 final one
canvas.drawText(message: "with the tourists", at: Point(x: 275, y: 430), size: 10, kerning: 0)
canvas.drawText(message: "multi death corporations", at: Point(x: 275, y: 415), size: 10, kerning: 0)
canvas.drawText(message: "new regime and red scare", at: Point(x: 275, y: 400), size: 10, kerning: 0)
/*:
 ## Use Source Control
